...
During the [presentation](https://mitre.app.box.com/s/3lynwg8ebc80lolprvz144ev8n04p19v/file/2025241729734), they demonstrated how their intelligence analysis identified **Ingress Tool Transfer** (T1105) and ****Application Layer Protocol: Web Protocols** (T1071.001)** as two techniques that frequently appear together across real-world threat activity. 
